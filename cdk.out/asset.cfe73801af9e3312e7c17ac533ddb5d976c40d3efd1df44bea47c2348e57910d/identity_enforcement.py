...
def enforce_user(user: str, month: str) -> None:
    ...
    _notify_outcome(user, month, mode, user_id, removed, dryrun, errored)
...
def _notify_outcome(
    ...
    """Send an operator email describing what enforcement just did. Only the
    actionable outcomes (REMOVED / DRYRUN / ERROR) notify; SKIPPED is silent."""
    if mode == "SKIPPED":
        return
